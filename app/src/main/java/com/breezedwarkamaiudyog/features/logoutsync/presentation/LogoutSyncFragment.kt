package com.breezedwarkamaiudyog.features.logoutsync.presentation
...
import com.breezedwarkamaiudyog.CustomConstants
...
import com.breezedwarkamaiudyog.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezedwarkamaiudyog.features.billing.api.AddBillingRepoProvider
import com.breezedwarkamaiudyog.features.billing.model.AddBillingInputParamsModel
...
import com.breezedwarkamaiudyog.features.dashboard.presentation.ReasonDialog
...
import com.breezedwarkamaiudyog.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.breezedwarkamaiudyog.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezedwarkamaiudyog.features.orderhistory.model.*
...
import com.breezedwarkamaiudyog.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezedwarkamaiudyog.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezedwarkamaiudyog.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezedwarkamaiudyog.features.timesheet.model.AddTimeSheetInputModel
import com.breezedwarkamaiudyog.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezedwarkamaiudyog.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezedwarkamaiudyog.features.viewAllOrder.model.AddOrderInputProductList
import com.breezedwarkamaiudyog.mappackage.SendBrod
import com.breezedwarkamaiudyog.widgets.AppCustomTextView
import com.breezedwarkamaiudyog.MonitorService
import com.breezedwarkamaiudyog.MySingleton
import com.breezedwarkamaiudyog.app.AlarmReceiver
...
import com.breezedwarkamaiudyog.features.addshop.presentation.ShopExtraContactReq
...
import com.breezedwarkamaiudyog.features.login.model.GetConcurrentUserResponse
...
import com.breezedwarkamaiudyog.features.orderITC.SyncDeleteOpptL
import com.breezedwarkamaiudyog.features.orderITC.SyncEditOppt
import com.breezedwarkamaiudyog.features.orderITC.SyncOppt
import com.breezedwarkamaiudyog.features.orderITC.SyncOpptProductL
import com.breezedwarkamaiudyog.features.orderITC.SyncOrd
import com.breezedwarkamaiudyog.features.orderITC.SyncOrdProductL
import com.breezedwarkamaiudyog.features.performance.model.Gps_status_list
import com.breezedwarkamaiudyog.features.performance.model.UpdateGpsInputListParamsModel
import com.breezedwarkamaiudyog.features.returnsOrder.ReturnProductList
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezedwarkamaiudyoglogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezedwarkamaiudyoglogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezedwarkamaiudyoglogsample/log.zip").path);
