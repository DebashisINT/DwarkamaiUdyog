package com.breezedwarkamaiudyog.features.dashboard.presentation
...
import com.breezedwarkamaiudyog.*
import com.breezedwarkamaiudyog.R
import com.breezedwarkamaiudyog.app.*
import com.breezedwarkamaiudyog.app.NewFileUtils.browseDocuments
import com.breezedwarkamaiudyog.app.NewFileUtils.browsePDFDocuments
import com.breezedwarkamaiudyog.app.NewFileUtils.getExtension
import com.breezedwarkamaiudyog.app.domain.*
import com.breezedwarkamaiudyog.app.types.DashboardType
import com.breezedwarkamaiudyog.app.types.FragType
import com.breezedwarkamaiudyog.app.types.TopBarConfig
import com.breezedwarkamaiudyog.app.uiaction.DisplayAlert
import com.breezedwarkamaiudyog.app.utils.*
import com.breezedwarkamaiudyog.app.utils.AppUtils.Companion.isProfile
...
import com.breezedwarkamaiudyog.features.NewQuotation.*
import com.breezedwarkamaiudyog.features.NewQuotation.api.GetQuotRegProvider
import com.breezedwarkamaiudyog.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezedwarkamaiudyog.features.SearchLocation.SearchLocationFragment
import com.breezedwarkamaiudyog.features.SearchLocation.locationInfoModel
import com.breezedwarkamaiudyog.features.TA.ViewAllTAListFragment
import com.breezedwarkamaiudyog.features.achievement.AchievementFragment
import com.breezedwarkamaiudyog.features.activities.presentation.*
import com.breezedwarkamaiudyog.features.addAttendence.*
import com.breezedwarkamaiudyog.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezedwarkamaiudyog.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezedwarkamaiudyog.features.addAttendence.model.GetReportToFCMResponse
import com.breezedwarkamaiudyog.features.addAttendence.model.GetReportToResponse
import com.breezedwarkamaiudyog.features.addAttendence.model.Leave_list_Response
import com.breezedwarkamaiudyog.features.addorder.presentation.AddOrderFragment
...
import com.breezedwarkamaiudyog.features.addshop.presentation.AddShopFragment
import com.breezedwarkamaiudyog.features.addshop.presentation.OTPVerificationDialog
import com.breezedwarkamaiudyog.features.addshop.presentation.ScanImageFragment
import com.breezedwarkamaiudyog.features.addshop.presentation.ShowCardDetailsDialog
import com.breezedwarkamaiudyog.features.alarm.model.AlarmData
import com.breezedwarkamaiudyog.features.alarm.presetation.AttendanceReportFragment
import com.breezedwarkamaiudyog.features.alarm.presetation.PerformanceReportFragment
import com.breezedwarkamaiudyog.features.alarm.presetation.VisitReportDetailsFragment
import com.breezedwarkamaiudyog.features.alarm.presetation.VisitReportFragment
import com.breezedwarkamaiudyog.features.attendance.AttendanceFragment
import com.breezedwarkamaiudyog.features.attendance.api.AttendanceRepositoryProvider
import com.breezedwarkamaiudyog.features.attendance.model.AttendanceRequest
import com.breezedwarkamaiudyog.features.attendance.model.AttendanceResponse
import com.breezedwarkamaiudyog.features.averageshop.presentation.AverageShopFragment
import com.breezedwarkamaiudyog.features.avgorder.presentation.AverageOrderFragment
import com.breezedwarkamaiudyog.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezedwarkamaiudyog.features.beatCustom.TeamBeatListFragment
import com.breezedwarkamaiudyog.features.billing.presentation.AddBillingFragment
import com.breezedwarkamaiudyog.features.billing.presentation.BillingDetailsFragment
import com.breezedwarkamaiudyog.features.billing.presentation.BillingListFragment
import com.breezedwarkamaiudyog.features.changepassword.presentation.ChangePasswordDialog
import com.breezedwarkamaiudyog.features.chat.model.ChatListDataModel
import com.breezedwarkamaiudyog.features.chat.model.ChatUserDataModel
import com.breezedwarkamaiudyog.features.chat.model.GroupUserDataModel
import com.breezedwarkamaiudyog.features.chat.presentation.*
import com.breezedwarkamaiudyog.features.chatbot.presentation.ChatBotFragment
import com.breezedwarkamaiudyog.features.chatbot.presentation.ChatBotShopListFragment
import com.breezedwarkamaiudyog.features.chatbot.presentation.ReportsFragment
import com.breezedwarkamaiudyog.features.chatbot.presentation.SelectLanguageDialog
...
import com.breezedwarkamaiudyog.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezedwarkamaiudyog.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezedwarkamaiudyog.features.commondialogsinglebtn.OnDialogClickListener
import com.breezedwarkamaiudyog.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezedwarkamaiudyog.features.contacts.ActivityDtlsFrag
import com.breezedwarkamaiudyog.features.contacts.AddOpptFrag
import com.breezedwarkamaiudyog.features.contacts.ContactDtls
import com.breezedwarkamaiudyog.features.contacts.ContactGr
import com.breezedwarkamaiudyog.features.contacts.ContactsAddFrag
import com.breezedwarkamaiudyog.features.contacts.ContactsFrag
import com.breezedwarkamaiudyog.features.contacts.SchedulerAddFormFrag
import com.breezedwarkamaiudyog.features.contacts.SchedulerViewFrag
import com.breezedwarkamaiudyog.features.contacts.TemplateAddFrag
import com.breezedwarkamaiudyog.features.contacts.TemplateViewFrag
import com.breezedwarkamaiudyog.features.contacts.ViewCrmOpptFrag
import com.breezedwarkamaiudyog.features.dailyPlan.prsentation.AllShopListFragment
import com.breezedwarkamaiudyog.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezedwarkamaiudyog.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezedwarkamaiudyog.features.damageProduct.ShopDamageProductListFrag
import com.breezedwarkamaiudyog.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezedwarkamaiudyog.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezedwarkamaiudyog.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezedwarkamaiudyog.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezedwarkamaiudyog.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezedwarkamaiudyog.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezedwarkamaiudyog.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezedwarkamaiudyog.features.dashboard.presentation.model.ContentListResponseModel
import com.breezedwarkamaiudyog.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezedwarkamaiudyog.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezedwarkamaiudyog.features.device_info.presentation.DeviceInfoListFragment
import com.breezedwarkamaiudyog.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezedwarkamaiudyog.features.document.DocumentRepoFeatureNewFragment
import com.breezedwarkamaiudyog.features.document.presentation.DocumentListFragment
import com.breezedwarkamaiudyog.features.document.presentation.DocumentTypeListFragment
import com.breezedwarkamaiudyog.features.document.presentation.OpenFileWebViewFragment
import com.breezedwarkamaiudyog.features.dymanicSection.presentation.AddDynamicFragment
import com.breezedwarkamaiudyog.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezedwarkamaiudyog.features.dymanicSection.presentation.DynamicListFragment
import com.breezedwarkamaiudyog.features.dymanicSection.presentation.EditDynamicFragment
import com.breezedwarkamaiudyog.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezedwarkamaiudyog.features.home.presentation.HomeFragment
import com.breezedwarkamaiudyog.features.homelocation.presentation.HomeLocationFragment
import com.breezedwarkamaiudyog.features.homelocation.presentation.HomeLocationMapFragment
import com.breezedwarkamaiudyog.features.know_your_state.KnowYourStateFragment
import com.breezedwarkamaiudyog.features.lead.LeadFrag
import com.breezedwarkamaiudyog.features.lead.ViewLeadFrag
import com.breezedwarkamaiudyog.features.leaderboard.LeaderBoardFrag
import com.breezedwarkamaiudyog.features.leaveapplynew.LeaveHome
import com.breezedwarkamaiudyog.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezedwarkamaiudyog.features.localshops.LocalShopListFragment
import com.breezedwarkamaiudyog.features.localshops.LocalShopListMapFragment
import com.breezedwarkamaiudyog.features.localshops.NearByShopsMapFragment
import com.breezedwarkamaiudyog.features.location.*
import com.breezedwarkamaiudyog.features.location.api.LocationRepoProvider
import com.breezedwarkamaiudyog.features.location.model.*
import com.breezedwarkamaiudyog.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezedwarkamaiudyog.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezedwarkamaiudyog.features.login.ShopFeedbackEntity
import com.breezedwarkamaiudyog.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezedwarkamaiudyog.features.login.presentation.LoginActivity
import com.breezedwarkamaiudyog.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezedwarkamaiudyog.features.logoutsync.presentation.LogoutSyncFragment
import com.breezedwarkamaiudyog.features.marketAssist.MarketAssistTabFrag
import com.breezedwarkamaiudyog.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezedwarkamaiudyog.features.marketAssist.ShopListMarketAssistFrag
import com.breezedwarkamaiudyog.features.marketing.presentation.MarketingPagerFragment
import com.breezedwarkamaiudyog.features.meetinglist.prsentation.MeetingListFragment
import com.breezedwarkamaiudyog.features.member.MapViewForTeamFrag
import com.breezedwarkamaiudyog.features.member.model.TeamLocDataModel
import com.breezedwarkamaiudyog.features.member.model.TeamShopListDataModel
import com.breezedwarkamaiudyog.features.member.presentation.*
import com.breezedwarkamaiudyog.features.menuBeat.MenuBeatFrag
import com.breezedwarkamaiudyog.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezedwarkamaiudyog.features.micro_learning.presentation.MicroLearningListFragment
import com.breezedwarkamaiudyog.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezedwarkamaiudyog.features.myallowancerequest.MyallowanceRequestFragment
import com.breezedwarkamaiudyog.features.myjobs.model.CustomerDataModel
import com.breezedwarkamaiudyog.features.myjobs.presentation.*
import com.breezedwarkamaiudyog.features.mylearning.MyLearningFragment
import com.breezedwarkamaiudyog.features.myorder.presentation.MyOrderListFragment
import com.breezedwarkamaiudyog.features.myprofile.presentation.MyProfileFragment
import com.breezedwarkamaiudyog.features.nearbyshops.api.ShopListRepositoryProvider
import com.breezedwarkamaiudyog.features.nearbyshops.model.ShopData
import com.breezedwarkamaiudyog.features.nearbyshops.model.ShopListResponse
import com.breezedwarkamaiudyog.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezedwarkamaiudyog.features.nearbyshops.presentation.BeatListFragment
import com.breezedwarkamaiudyog.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezedwarkamaiudyog.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezedwarkamaiudyog.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezedwarkamaiudyog.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezedwarkamaiudyog.features.newcollection.CollectionDetailsStatusFragment
import com.breezedwarkamaiudyog.features.newcollection.CollectionShopListFragment
import com.breezedwarkamaiudyog.features.newcollection.NewCollectionListFragment
import com.breezedwarkamaiudyog.features.newcollectionreport.*
import com.breezedwarkamaiudyog.features.notification.NotificationFragment
import com.breezedwarkamaiudyog.features.orderITC.CartListFrag
import com.breezedwarkamaiudyog.features.orderITC.OrderListFrag
import com.breezedwarkamaiudyog.features.orderITC.ProductListFrag
import com.breezedwarkamaiudyog.features.orderITC.ViewNewOrdHisAllFrag
import com.breezedwarkamaiudyog.features.orderITC.ViewNewOrdHistoryFrag
import com.breezedwarkamaiudyog.features.orderITC.ViewOrdDtls
import com.breezedwarkamaiudyog.features.orderList.NewDateWiseOrderListFragment
import com.breezedwarkamaiudyog.features.orderList.NewOrderListFragment
import com.breezedwarkamaiudyog.features.orderList.OrderListFragment
import com.breezedwarkamaiudyog.features.orderdetail.presentation.OrderDetailFragment
import com.breezedwarkamaiudyog.features.orderhistory.ActivityMapFragment
import com.breezedwarkamaiudyog.features.orderhistory.OrderhistoryFragment
import com.breezedwarkamaiudyog.features.orderhistory.TimeLineFragment
import com.breezedwarkamaiudyog.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.breezedwarkamaiudyog.features.orderhistory.model.LocationData
import com.breezedwarkamaiudyog.features.pendinglocationinout.PendingOutLocationFrag
import com.breezedwarkamaiudyog.features.performance.GpsStatusFragment
import com.breezedwarkamaiudyog.features.performance.PerformanceFragment
import com.breezedwarkamaiudyog.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezedwarkamaiudyog.features.performance.model.UpdateGpsInputParamsModel
import com.breezedwarkamaiudyog.features.performanceAPP.OwnPerformanceFragment
import com.breezedwarkamaiudyog.features.performanceAPP.PerformanceAppFragment
import com.breezedwarkamaiudyog.features.performanceAPP.allPerformanceFrag
import com.breezedwarkamaiudyog.features.permissionList.ViewPermissionFragment
import com.breezedwarkamaiudyog.features.photoReg.*
import com.breezedwarkamaiudyog.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezedwarkamaiudyog.features.quotation.presentation.*
import com.breezedwarkamaiudyog.features.reimbursement.presentation.*
import com.breezedwarkamaiudyog.features.report.presentation.*
import com.breezedwarkamaiudyog.features.returnsOrder.*
import com.breezedwarkamaiudyog.features.settings.presentation.SettingsFragment
import com.breezedwarkamaiudyog.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezedwarkamaiudyog.features.shopdetail.presentation.*
import com.breezedwarkamaiudyog.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezedwarkamaiudyog.features.stock.StockDetailsFragment
import com.breezedwarkamaiudyog.features.stock.StockListFragment
import com.breezedwarkamaiudyog.features.stockAddCurrentStock.AddShopStockFragment
import com.breezedwarkamaiudyog.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezedwarkamaiudyog.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezedwarkamaiudyog.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezedwarkamaiudyog.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezedwarkamaiudyog.features.stockCompetetorStock.CompetetorStockFragment
import com.breezedwarkamaiudyog.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezedwarkamaiudyog.features.survey.SurveyFrag
import com.breezedwarkamaiudyog.features.survey.SurveyViewDtlsFrag
import com.breezedwarkamaiudyog.features.survey.SurveyViewFrag
import com.breezedwarkamaiudyog.features.task.presentation.AddTaskFragment
import com.breezedwarkamaiudyog.features.task.presentation.CalenderTaskFragment
import com.breezedwarkamaiudyog.features.task.presentation.EditTaskFragment
import com.breezedwarkamaiudyog.features.task.presentation.TaskListFragment
import com.breezedwarkamaiudyog.features.taskManagement.TaskManagementFrag
import com.breezedwarkamaiudyog.features.taskManagement.ViewTaskManagementFrag
import com.breezedwarkamaiudyog.features.timesheet.presentation.AddTimeSheetFragment
import com.breezedwarkamaiudyog.features.timesheet.presentation.EditTimeSheetFragment
import com.breezedwarkamaiudyog.features.timesheet.presentation.TimeSheetListFragment
import com.breezedwarkamaiudyog.features.viewAllOrder.CartFragment
import com.breezedwarkamaiudyog.features.viewAllOrder.OrderTypeListFragment
import com.breezedwarkamaiudyog.features.viewAllOrder.ViewAllOrderListFragment
import com.breezedwarkamaiudyog.features.viewAllOrder.ViewCartFragment
import com.breezedwarkamaiudyog.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezedwarkamaiudyog.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezedwarkamaiudyog.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezedwarkamaiudyog.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezedwarkamaiudyog.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezedwarkamaiudyog.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezedwarkamaiudyog.features.viewPPDDStock.ViewOutstandingFragment
import com.breezedwarkamaiudyog.features.viewPPDDStock.ViewPPDDListFragment
import com.breezedwarkamaiudyog.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezedwarkamaiudyog.features.viewPPDDStock.ViewStockFragment
import com.breezedwarkamaiudyog.features.weather.presentation.WeatherFragment
import com.breezedwarkamaiudyog.mappackage.MapActivity
import com.breezedwarkamaiudyog.mappackage.MapActivityWithoutPath
import com.breezedwarkamaiudyog.mappackage.SendBrod
...
import com.breezedwarkamaiudyog.features.mylearning.KnowledgeHubAllVideoList
import com.breezedwarkamaiudyog.features.mylearning.LeaderboardLmsFrag
import com.breezedwarkamaiudyog.features.mylearning.MyLearningAllVideoList
import com.breezedwarkamaiudyog.features.mylearning.MyPerformanceFrag
import com.breezedwarkamaiudyog.features.mylearning.SearchLmsFrag
import com.breezedwarkamaiudyog.features.mylearning.SearchLmsKnowledgeFrag
import com.breezedwarkamaiudyog.features.mylearning.SearchLmsLearningFrag
import com.breezedwarkamaiudyog.features.mylearning.VideoPlayLMS
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezedwarkamaiudyoglogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezedwarkamaiudyoglogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.breezedwarkamaiudyog/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezedwarkamaiudyoglogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezedwarkamaiudyoglogsample/log.bak.1").path);
...
//                                clearData()
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            android.R.id.home -> {
                if (supportFragmentManager.backStackEntryCount == 0 || getCurrentFragType() == FragType.DashboardFragment || getCurrentFragType() == FragType.MyLearningFragment) {
                    AppUtils.hideSoftKeyboard(this)
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezedwarkamaiudyoglogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezedwarkamaiudyoglogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
